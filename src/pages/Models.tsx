...
const Models: React.FC = () => {
  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-10 px-4 py-12 sm:px-6 lg:px-8">
      ...
      {/* Search & Filters */}
      <div className="rounded-[2.5rem] bg-brand-card p-8 border border-brand-border shadow-xl">
        <div className="mb-8 flex gap-4">
          ...
          <button className="flex h-12 items-center gap-2 rounded-xl bg-brand-primary px-8 font-bold text-white transition-all hover:bg-blue-500 shadow-lg shadow-brand-primary/20">
            Filtrar
          </button>
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          {CATEGORIES.map(cat => (
            <button
              ...
              className={`rounded-xl px-6 py-2 text-sm font-bold transition-all border ${
